...
- **Chip trạng thái (C1)**: chữ nhật, viền 1px mực; `--dashed` cho giữ chỗ; `--gilt` (viền vàng quỳ 2px) cho "Đầy đủ" ở hub. Chỉ để đọc.
